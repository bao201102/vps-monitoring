...
const schema = z.object({
  ...
  services: z.array(z.object({
    ...
    // Extended metadata
    fragmentPath: z.string().nullable().optional(),
    mainPid: z.number().nullable().optional(),
    nRestarts: z.number().nullable().optional(),
    tasksCurrent: z.number().nullable().optional(),
    tasksMax: z.number().nullable().optional(),
    requires: z.array(z.string()).optional(),
    documentation: z.array(z.string()).optional(),
    unitFileState: z.string().nullable().optional(),
    loadState: z.string().nullable().optional(),
    activeEnterTimestamp: z.string().nullable().optional(),
    ...
    cpuUsageNSec: z.number().nullable().optional(),
    memoryPeak: z.number().nullable().optional(),
    memoryLimit: z.number().nullable().optional(),
    canStart: z.string().optional(),
    canStop: z.string().optional(),
    canReload: z.string().optional(),
  })).optional(),
